...
<section class="bg0 p-t-104 p-b-116">
    <div class="container">
        ...
        <div>
            <h3 class="mtext-105 cl2 txt-center p-b-30">Sekarang Anda Mendaftar Sebagai Partner</h3>
        </div>
        <div class="form-login">
            <h4 class="mtext-105 cl2 txt-center p-b-30">
                <a href="<?php echo site_url('Register'); ?>"><h6>Ingin Mendaftar sebagai Pendonor?</h6></a>
            </h4>
            <form action="<?php echo site_url('Register/Partner_Insert'); ?>" method="post">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="kverifikasi" placeholder="Kode Verifikasi">
                    </div>
                </div> -->
                <div class="form-group">

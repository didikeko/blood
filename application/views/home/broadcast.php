  ...
  <div class="container">
    <div class="flex-w flex-tr">
      <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
        <form action="<?php echo site_url('partner/Broadcast/message'); ?>" method="post">
          ...
          <div class="form-group">
            <div class="bor8 m-b-20 how-pos4-parent">
              <select name="blood" class="form-control stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="sel1" style="height: 34px">
         ...
         <!--  <div class="bor8 m-b-20 how-pos4-parent">
          ...
          <div class="form-group">
            <div class="bor8 m-b-20 how-pos4-parent">
              <select name="gender" class="form-control stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="sel1" style="height: 34px">

			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="<?php echo site_url('welcome/register'); ?>" class="flex-c-m trans-04 p-lr-25">
							REGISTER
						</a>

						<a href="<?php echo site_url('welcome/login'); ?>" class="flex-c-m trans-04 p-lr-25">
							LOG IN
						</a>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu" >
							...
							<li>
								<a href="<?php echo site_url('welcome/broadcast'); ?>">Broadcast</a>
							</li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart"  data-notify="5">
							<i class="material-icons" style="color: #F44336">add_circle</i>
						</div>

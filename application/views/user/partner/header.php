  ...
  <!-- =======================================================
        ...
        <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
            <script>
                ...
                // $('#update_partner').bind('click',function(e){
                //          var values = $('#profile-form').serialize();
                //          $.ajax({
                //                 url: "<?php //echo site_url('Partner/Dashboard/update_partner'); ?>",
                //                 type: "post",
                //                 data: values ,
                //                 success: function (response) {
                //                     // $(this).prop('disabled', true);
                //                     //  $("#displayHasil").html(response);           
                ...
                $('span').bind('click',function(e){
                    if ($popupStatus==false) {
                        ...
                        var values = $(this).next('#f1').serialize();
                         $.ajax({
                                url: "<?php echo site_url('partner/verify/verified'); ?>",
                                type: "post",
                                data: values ,
                                success: function (response) {
                        ...
                        var values = $(this).next('#f1').serialize();
                         $.ajax({
                                url: "<?php echo site_url('partner/verify/cancel_verified'); ?>",
                                type: "post",
                                data: values ,
                                success: function (response) {
                                    // $("#display1").html(response);           

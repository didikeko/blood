                    ...
                    <div id="account">
                        <div class="entity-description-item">
                            ...
                            <div class="row-paragraph">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo site_url ('Pendonor/DashboardPo/update_pendonor');?>" accept-charset="UTF-8" role="form" id="profile-form" class="form-horizontal js-bootstrap-validator">
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="name">Nama</label>
                                        <div class="col-sm-10">
                                            <input name="nama" type="text" class="form-control" id="name" value="<?php echo $user[0]['nama'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="gender" style="height: 34px">
                                                <option value="Tidak disebutkan" selected="selected">Memilih untuk tidak menyebutkan</option>
                                                <option value="laki-laki">Laki-laki</option>
                                                <option value="perempuan">Perempuan</option>
                                                </select>
                                                <span class="help-block">Jenis Kelamin: <?php echo $value->jenis_kelamin?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="image">Avatar</label>
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <input type="file" name="image" value="<?php echo base_url ().'assets/images/profil/'.$value->foto?>" title="Change Avatar"  data-filename-placement="inside">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="phone">Umur</label>
                                            <div class="col-sm-10">
                                                <input name="umur" type="text" class="form-control" id="umur" value="<?php echo $value->umur?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <span class="help-block">Kota saat ini:</span>
                                            </div>
                                        </div>
                            ...
                            <div class="entity-description-item">
                                <div class="row-paragraph">
                                    ...
                                    <div class="spacier">
                                        ...
                                        <form method="POST" action="<?php echo site_url ('Pendonor/DashboardPo/update_password');?>" accept-charset="UTF-8" role="form" id="email-update" class="form-horizontal">

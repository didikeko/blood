...
class Api_pendonor extends REST_Controller {
    ...
    public function user_get($kota = 0) {
        //returns all rows if the id parameter doesn't exist,
        //otherwise single row will be returned
        $blood= $this->input->get('blood');
        $users = $this->Pendonor_model->getRows($kota,$blood);
    ...
    //         //insert user data
    //         $insert = $this->Pendonor_model->insert($userData);
    //
